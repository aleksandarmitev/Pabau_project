...
I managed by myself to implement Apollo Client and to show past missions on landing page on my react app.I used newest version of bootstrap and css.
  ...
  My main project is in folder "pabaufinal", and to succesfully install and run on vs code, it needs to open the project in vs code(File-> Open) and when you open the folder it needs to open new terminal from vs code and to write commands "npm install" and then "npm start". Versions to succesfully run this project for apollo client and  graphql are "@apollo/client": "^3.4.17","graphql": "^15.7.2"
